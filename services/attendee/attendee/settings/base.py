...
if STORAGE_PROTOCOL == "azure":
    ...
    # Path-style is required for most MinIO / custom S3 endpoints.
    # Real AWS S3 usually wants virtual hosting (set AWS_S3_ADDRESSING_STYLE=virtual).
    _aws_endpoint_url = os.getenv("AWS_ENDPOINT_URL") or None
    _aws_addressing_style = os.getenv(
        "AWS_S3_ADDRESSING_STYLE",
        "path" if _aws_endpoint_url else "virtual",
    )
    _aws_region = os.getenv("AWS_DEFAULT_REGION") or os.getenv("AWS_S3_REGION_NAME") or "us-east-1"
    DEFAULT_STORAGE_BACKEND = {
        ...
        "OPTIONS": {
            ...
            "addressing_style": _aws_addressing_style,
...
AWS_S3_ADDRESSING_STYLE = os.getenv(
    "AWS_S3_ADDRESSING_STYLE",
    "path" if os.getenv("AWS_ENDPOINT_URL") else "virtual",
)
