...
class MatchingPromptBuilder:
    """Builds the LLM prompt for resume-JD job fit analysis."""

    def build(self, resume_data: ParsedResumeData, jd_data: ParsedJDData) -> str:
...
matching_prompt_builder = MatchingPromptBuilder()
