...
- good_to_have_skills: If the job description contains a dedicated “Good to Have,” “Good-to-have skills,” “Nice to Have,” “Preferred,” or equivalent section, extract skills from that section. Otherwise, extract supporting technologies, tools, methodologies, soft skills, leadership skills, and less-central technical skills explicitly mentioned in the JD.
- Also treat “Tools & stack” items as skills (prefer must_have when clearly core to the role; otherwise good_to_have).
- Domain / industry experience lines are context for the role; do not invent skill names from them unless a concrete technology is named.
- Prefer section headings when present: Role overview, About the company, Responsibilities, Must-have skills, Good-to-have skills, Qualifications, Domain / industry experience, Tools & stack.
